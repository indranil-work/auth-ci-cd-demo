function (user, context, callback) {
   ...
   * Unknown at 2023-08-16T22:47:13.649Z
   */
  ...
  var config = {
    endpoints: {
      linking: 'https://ijdemo.us.webtask.run/4cb95bf92ced903b9b84ebedbf5ebffd',
      userApi: auth0.baseUrl + '/users',
      usersByEmailApi: auth0.baseUrl + '/users-by-email'
    },
    token: {
      clientId: 'Vh8oA8VG5Vb6xLoieGpR1qHQGxXLhxtz',
      clientSecret: 'lXT2wfE_1_5cNzXtaKLbG-SYWUf0ZUZ_j4Vgf2hVF3eb6JOBHXxa1eX65MHuVLSf',
      issuer: auth0.domain
    }
  };
